...
const ScheduledDrugsReport: React.FC = () => {
  ...
  const dispensingColumns: TableColumn<DispensingRow>[] = [
    { key: 'entry_date', header: L.TABLE.DATE, sortable: true, render: (r) => <CellText>{formatReportDate(r.entry_date)}</CellText> },
    { key: 'typeDisplay', header: L.TABLE.TYPE, sortable: true, render: (r) => <CellText>{r.typeDisplay}</CellText> },
    { key: 'document_number', header: L.TABLE.DOC_NUMBER, sortable: true, render: (r) => <CellText>{r.document_number || '-'}</CellText> },
    ...
    { key: 'schedule', header: L.TABLE.SCHEDULE, sortable: true, render: (r) => <CellText>{formatSchedule(r.schedule) || '-'}</CellText> },
    { key: 'batch_number', header: L.TABLE.BATCH, sortable: true, render: (r) => <CellText>{r.batch_number || '-'}</CellText> },
    { key: 'qtyN', header: L.TABLE.QTY, sortable: true, render: (r) => qtyCell(r.qtyN, r.direction) },
    { key: 'direction', header: L.TABLE.DIRECTION, sortable: true, render: (r) => directionCell(r.direction) },
  ];
  const receiptColumns: TableColumn<ReceiptRow>[] = [
    { key: 'entry_date', header: L.TABLE.DATE, sortable: true, render: (r) => <CellText>{formatReportDate(r.entry_date)}</CellText> },
    { key: 'typeDisplay', header: L.TABLE.TYPE, sortable: true, render: (r) => <CellText>{r.typeDisplay}</CellText> },
    { key: 'document_number', header: L.TABLE.RECEIPT_DOC_NUMBER, sortable: true, render: (r) => <CellText>{r.document_number || '-'}</CellText> },
