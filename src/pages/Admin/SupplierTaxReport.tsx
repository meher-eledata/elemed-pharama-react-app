...
const SupplierTaxReport: React.FC = () => {
  ...
  const receiptColumns: TableColumn<ReceiptViewRow>[] = [
    ...
    { key: 'cgstN', header: L.TABLE_RECEIPT.CGST, sortable: true, nowrap: true, render: (r) => <CellText>{formatNumber(r.cgstN)}</CellText> },
    { key: 'sgstN', header: L.TABLE_RECEIPT.SGST, sortable: true, nowrap: true, render: (r) => <CellText>{formatNumber(r.sgstN)}</CellText> },
    { key: 'igstN', header: L.TABLE_RECEIPT.IGST, sortable: true, nowrap: true, render: (r) => <CellText>{formatNumber(r.igstN)}</CellText> },
    { key: 'totalTaxN', header: L.TABLE_RECEIPT.TOTAL_TAX, sortable: true, nowrap: true, render: (r) => <CellText weight={600}>{formatNumber(r.totalTaxN)}</CellText> },
    { key: 'gstRateN', header: L.TABLE_RECEIPT.GST_PERCENT, sortable: true, nowrap: true, render: (r) => <CellText>{r.gstRateN == null ? '-' : formatPercent(r.gstRateN)}</CellText> },
    { key: 'receiptTotalN', header: L.TABLE_RECEIPT.RECEIPT_TOTAL, sortable: true, nowrap: true, render: (r) => <CellText weight={600}>{formatCurrency(r.receiptTotalN)}</CellText> },
  ];
  ...
  const supplierColumns: TableColumn<SupplierViewRow>[] = [
    ...
    { key: 'discountN', header: L.TABLE_SUPPLIER.DISCOUNT, sortable: true, nowrap: true, render: (r) => <CellText>{formatNumber(r.discountN)}</CellText> },
    { key: 'cgstN', header: L.TABLE_SUPPLIER.CGST, sortable: true, nowrap: true, render: (r) => <CellText>{formatNumber(r.cgstN)}</CellText> },
    { key: 'sgstN', header: L.TABLE_SUPPLIER.SGST, sortable: true, nowrap: true, render: (r) => <CellText>{formatNumber(r.sgstN)}</CellText> },
    { key: 'igstN', header: L.TABLE_SUPPLIER.IGST, sortable: true, nowrap: true, render: (r) => <CellText>{formatNumber(r.igstN)}</CellText> },
    { key: 'totalTaxN', header: L.TABLE_SUPPLIER.TOTAL_TAX, sortable: true, nowrap: true, render: (r) => <CellText weight={600}>{formatNumber(r.totalTaxN)}</CellText> },
    { key: 'gstRateN', header: L.TABLE_SUPPLIER.GST_PERCENT, sortable: true, nowrap: true, render: (r) => <CellText>{r.gstRateN == null ? '-' : formatPercent(r.gstRateN)}</CellText> },
    { key: 'totalWithTaxN', header: L.TABLE_SUPPLIER.TOTAL_WITH_TAX, sortable: true, nowrap: true, render: (r) => <CellText weight={600}>{formatCurrency(r.totalWithTaxN)}</CellText> },
  ];
