...
const ProductSalesReport: React.FC = () => {
  ...
  const columns: TableColumn<SalesRow>[] = [
    ...
    { key: 'patientDisplay', header: L.TABLE.PATIENT_TYPE, sortable: true, nowrap: true, render: (r) => <CellText>{r.patientDisplay}</CellText> },
    { key: 'customer_name', header: L.TABLE.CUSTOMER, sortable: true, columnWidth: '160px', render: (r) => <CellText>{r.customer_name || '-'}</CellText> },
    ...
    { key: 'unitMrpN', header: L.TABLE.MRP, sortable: true, nowrap: true, render: (r) => <CellText>{formatNumber(r.unitMrpN)}</CellText> },
    { key: 'spAfterDiscN', header: L.TABLE.SP, sortable: true, nowrap: true, render: (r) => <CellText>{formatNumber(r.spAfterDiscN)}</CellText> },
    { key: 'discPctN', header: L.TABLE.DISCOUNT_PCT, sortable: true, nowrap: true, render: (r) => <CellText>{formatPercent(r.discPctN)}</CellText> },
    { key: 'discAmtN', header: L.TABLE.DISCOUNT_AMT, sortable: true, nowrap: true, render: (r) => <CellText>{formatNumber(r.discAmtN)}</CellText> },
    { key: 'cgstN', header: L.TABLE.CGST_AMT, sortable: true, nowrap: true, render: (r) => <CellText>{formatCurrency(r.cgstN)}</CellText> },
    { key: 'sgstN', header: L.TABLE.SGST_AMT, sortable: true, nowrap: true, render: (r) => <CellText>{formatCurrency(r.sgstN)}</CellText> },
    { key: 'igstN', header: L.TABLE.IGST_AMT, sortable: true, nowrap: true, render: (r) => <CellText>{formatCurrency(r.igstN)}</CellText> },
