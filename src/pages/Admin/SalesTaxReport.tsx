...
const SalesTaxReport: React.FC = () => {
  ...
  const columns: TableColumn<TaxRow>[] = [
    ...
    { key: 'taxableN', header: L.TABLE.TAXABLE_VALUE, sortable: true, nowrap: true, render: (r) => <CellText>{formatNumber(r.taxableN)}</CellText> },
    { key: 'discountN', header: L.TABLE.DISCOUNT, sortable: true, nowrap: true, render: (r) => <CellText>{formatNumber(r.discountN)}</CellText> },
    { key: 'cgstRateN', header: L.TABLE.CGST_RATE, sortable: true, nowrap: true, render: (r) => <CellText>{formatPercent(r.cgstRateN)}</CellText> },
    { key: 'sgstRateN', header: L.TABLE.SGST_RATE, sortable: true, nowrap: true, render: (r) => <CellText>{formatPercent(r.sgstRateN)}</CellText> },
    { key: 'igstRateN', header: L.TABLE.IGST_RATE, sortable: true, nowrap: true, render: (r) => <CellText>{formatPercent(r.igstRateN)}</CellText> },
    { key: 'cgstN', header: L.TABLE.CGST_AMT, sortable: true, nowrap: true, render: (r) => <CellText>{formatNumber(r.cgstN)}</CellText> },
    { key: 'sgstN', header: L.TABLE.SGST_AMT, sortable: true, nowrap: true, render: (r) => <CellText>{formatNumber(r.sgstN)}</CellText> },
    { key: 'igstN', header: L.TABLE.IGST_AMT, sortable: true, nowrap: true, render: (r) => <CellText>{formatNumber(r.igstN)}</CellText> },
    { key: 'totalTaxN', header: L.TABLE.TOTAL_TAX, sortable: true, nowrap: true, render: (r) => <CellText weight={600}>{formatNumber(r.totalTaxN)}</CellText> },
    { key: 'lineTotalN', header: L.TABLE.LINE_TOTAL, sortable: true, nowrap: true, render: (r) => <CellText weight={600}>{formatCurrency(r.lineTotalN)}</CellText> },
  ];

  const hsnColumns: TableColumn<HsnRow>[] = [
    { key: 'hsn_code', header: L.TABLE_HSN.HSN, sortable: true, nowrap: true, render: (r) => <CellText>{r.hsn_code || '-'}</CellText> },
    { key: 'line_count', header: L.TABLE_HSN.LINES, sortable: true, nowrap: true, render: (r) => <CellText>{formatCount(r.line_count)}</CellText> },
    { key: 'product_count', header: L.TABLE_HSN.PRODUCTS, sortable: true, nowrap: true, render: (r) => <CellText>{formatCount(r.product_count)}</CellText> },
    { key: 'quantityN', header: L.TABLE_HSN.QTY, sortable: true, nowrap: true, render: (r) => <CellText>{formatNumber(r.quantityN)}</CellText> },
    { key: 'taxableN', header: L.TABLE_HSN.TAXABLE_VALUE, sortable: true, nowrap: true, render: (r) => <CellText>{formatNumber(r.taxableN)}</CellText> },
    { key: 'discountN', header: L.TABLE_HSN.DISCOUNT, sortable: true, nowrap: true, render: (r) => <CellText>{formatNumber(r.discountN)}</CellText> },
    { key: 'cgstRateN', header: L.TABLE_HSN.CGST_RATE, sortable: true, nowrap: true, render: (r) => <CellText>{formatPercent(r.cgstRateN)}</CellText> },
    { key: 'sgstRateN', header: L.TABLE_HSN.SGST_RATE, sortable: true, nowrap: true, render: (r) => <CellText>{formatPercent(r.sgstRateN)}</CellText> },
    { key: 'igstRateN', header: L.TABLE_HSN.IGST_RATE, sortable: true, nowrap: true, render: (r) => <CellText>{formatPercent(r.igstRateN)}</CellText> },
    { key: 'cgstN', header: L.TABLE_HSN.CGST_AMT, sortable: true, nowrap: true, render: (r) => <CellText>{formatNumber(r.cgstN)}</CellText> },
    { key: 'sgstN', header: L.TABLE_HSN.SGST_AMT, sortable: true, nowrap: true, render: (r) => <CellText>{formatNumber(r.sgstN)}</CellText> },
    { key: 'igstN', header: L.TABLE_HSN.IGST_AMT, sortable: true, nowrap: true, render: (r) => <CellText>{formatNumber(r.igstN)}</CellText> },
    { key: 'totalTaxN', header: L.TABLE_HSN.TOTAL_TAX, sortable: true, nowrap: true, render: (r) => <CellText weight={600}>{formatNumber(r.totalTaxN)}</CellText> },
    { key: 'lineTotalN', header: L.TABLE_HSN.TOTAL, sortable: true, nowrap: true, render: (r) => <CellText weight={600}>{formatCurrency(r.lineTotalN)}</CellText> },
  ];
  ...
  const invoiceColumns: TableColumn<InvoiceRow>[] = [
    ...
    { key: 'discountN', header: L.TABLE_INVOICE.DISCOUNT, sortable: true, nowrap: true, render: (r) => <CellText>{formatNumber(r.discountN)}</CellText> },
    { key: 'cgstN', header: L.TABLE_INVOICE.CGST_AMT, sortable: true, nowrap: true, render: (r) => <CellText>{formatNumber(r.cgstN)}</CellText> },
    { key: 'sgstN', header: L.TABLE_INVOICE.SGST_AMT, sortable: true, nowrap: true, render: (r) => <CellText>{formatNumber(r.sgstN)}</CellText> },
    { key: 'igstN', header: L.TABLE_INVOICE.IGST_AMT, sortable: true, nowrap: true, render: (r) => <CellText>{formatNumber(r.igstN)}</CellText> },
    { key: 'totalTaxN', header: L.TABLE_INVOICE.TOTAL_TAX, sortable: true, nowrap: true, render: (r) => <CellText weight={600}>{formatNumber(r.totalTaxN)}</CellText> },
    // Signed 2dp — paise matter for the round-off adjustment.
    { key: 'roundOffN', header: L.TABLE_INVOICE.ROUND_OFF, sortable: true, nowrap: true, render: (r) => <CellText>{formatSignedCurrency(r.roundOffN)}</CellText> },
    { key: 'invoiceTotalN', header: L.TABLE_INVOICE.INVOICE_TOTAL, sortable: true, nowrap: true, render: (r) => <CellText weight={600}>{formatWholeCurrency(r.invoiceTotalN)}</CellText> },
  ];
