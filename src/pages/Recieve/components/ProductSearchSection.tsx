            ...
            <Box sx={{ display: "flex", flexDirection: "column", gap: "4px" }}>
              ...
              <Box
                ...
                sx={{
                  ...
                  minWidth: "180px",
                  boxShadow:
                    "0 0 0 3px rgba(92, 23, 229, 0.08), 0 0 12px 2px rgba(92, 23, 229, 0.18)",
                  animation: "elemedAiGlow 2.8s ease-in-out infinite",
                  "@keyframes elemedAiGlow": {
                    "0%, 100%": {
                      boxShadow:
                        "0 0 0 3px rgba(92, 23, 229, 0.08), 0 0 10px 2px rgba(92, 23, 229, 0.15)",
                    },
                    "50%": {
                      boxShadow:
                        "0 0 0 4px rgba(92, 23, 229, 0.12), 0 0 16px 4px rgba(92, 23, 229, 0.28)",
                    },
                  },
                  "&:hover": {
                    borderColor: "#5C17E5",
                    backgroundColor: "#F3E8FF",
                    boxShadow:
                      "0 0 0 4px rgba(92, 23, 229, 0.14), 0 0 18px 5px rgba(92, 23, 229, 0.32)",
                    animation: "none",
                  },
                }}
              >
