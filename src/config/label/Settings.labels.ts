export const SETTINGS_LABELS = {
  ...
  SECTIONS: {
    ...
    INVOICE_NUMBERING: {
      ...
      DESC: 'Configure a custom invoice-number scheme for your pharmacy.',
      READ_ONLY_NOTE: 'Only an owner or admin can edit invoice numbering.',
      ENABLE_LABEL: 'Use a custom invoice-number scheme',
      TEMPLATE_LABEL: 'Invoice number template',
      TEMPLATE_HELP:
      ...
      TEMPLATE_EXAMPLE: 'Example: SI-EL-{YY}-{SEQ:6} with starting number 2296 becomes SI-EL-26-002296.',
      START_LABEL: 'Starting number',
      RESET_LABEL: 'Reset sequence',
      RESET_NONE: 'None',
      RESET_YEARLY: 'Yearly',
      PREVIEW_PREFIX: 'Next invoice will look like: ',
      SAVE_BUTTON: 'Save Numbering',
      SAVE_SUCCESS: 'Invoice numbering updated.',
      SAVE_ERROR: 'Could not update invoice numbering.',
      TEMPLATE_REQUIRED: 'A template is required when the custom scheme is enabled.',
      START_INVALID: 'Starting number must be a whole number of 0 or more.',
    },
    DAILY_REPORTS: {
